      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex-shrink-0">
            <Link href="/" className="flex items-center space-x-2">
              <div className="size-8 rounded-lg bg-gradient-to-br from-primary to-primary/60 flex items-center justify-center">
                <Car className="size-4 text-background" />
              </div>
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Button size="sm" className="group bg-accent hover:bg-accent/90 text-background">
              Book Trip
              <MapPin className="ml-2 size-4 transition-transform group-hover:translate-x-1" />
            </Button>
          </div>
        ...
        >
          <div className="px-2 pt-2 pb-3 space-y-1 border-t">
            ...
            <div className="pt-4 flex flex-col space-y-2">
              ...
              <Button className="justify-start group bg-accent hover:bg-accent/90 text-background">
                Book Trip
                <MapPin className="ml-2 size-4 transition-transform group-hover:translate-x-1" />
              </Button>
            </div>
