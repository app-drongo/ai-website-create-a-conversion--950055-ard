...
import { ArrowRight, Car, Users, Clock, Shield } from "lucide-react"

export default function Cta() {
  const stats = [
    { value: "10K+", label: "Happy Clients", icon: Users },
    { value: "99.8%", label: "On-Time Rate", icon: Clock },
    { value: "500+", label: "Professional Drivers", icon: Car },
    { value: "24/7", label: "Service Available", icon: Shield }
  ]
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                ...
                Book your premium ride today and travel in comfort and style.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Trusted by leading corporations and discerning travelers
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Reserve your ride in minutes, no advance notice required
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                All drivers are professionally licensed and fully insured
              </p>
            </div>
